  ...
  return (
   <div className="pb-4 lg:mb-36">
    <div className="flex flex-wrap lg:flex-row-reverse">
        ...
        <motion.img src={profilePic} alt="Samuel Maina" className="border border-stone-900 rounded-3xl" 
        width={650}
        height={650}
        ...
        className="flex flex-col items-center lg:items-start mt-10">
            ...
            className="pb-2 text-4xl tracking-tighter lg:text-8xl">Samuel Maina</motion.h2>
            <motion.span 
            variants={childrenVariants}
